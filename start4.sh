...
##########################################################################################    NQ/
APP_INSTALL="unzip"; [[ $($APP_INSTALL -v) = *"not found"* ]] || sudo apt-get install $APP_INSTALL -y
APP_INSTALL="wget"; [[ $($APP_INSTALL -v) = *"not found"* ]] || sudo apt-get install $APP_INSTALL -y
...
##########################################################################################    TAILSCALE/
APP_INSTALL="lsof"; [[ $($APP_INSTALL -v) = *"not found"* ]] || sudo apt-get install $APP_INSTALL -y
...
APP_INSTALL="nano"; [[ $($APP_INSTALL -v) = *"not found"* ]] || nq sudo apt-get install $APP_INSTALL -y
APP_INSTALL="git"; [[ $($APP_INSTALL -v) = *"not found"* ]] || nq sudo apt-get install $APP_INSTALL -y && git config --global user.name abraxas678 && git config --global user.email abraxas678@gmail.com
ng -w
